...
export class Delete {
  /*
  this method is used to mark message as deleted in both the cache and the DB
  updatedMessage: marks a message as deleted in the cache
  chatQueue.addChatJob: marks a message as deleted in the DB
  */
