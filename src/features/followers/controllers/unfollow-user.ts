...
/*
Steps
Remove followerId and followeeId from cache
Reduce their follower/following Count prop

followerId = req.currentUser!.userId}
NOTE:  the same service to add a follower was used to remove a follower
*/
export class Remove {
