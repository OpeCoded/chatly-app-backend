...
/*
followerId, followeeId: are the ids generated for users in our user model
followerId: someone following another user
followeeId: someone that is being followed
*/
