...
/*
this.router.post: HTTP POST method
/post: route name
authMiddleware.checkAuthentication: middle ware to check if current user exists
Create.prototype.post: controller class and method


/post/all/:page: ROUTE NAME/:PARAM
*/
