...
/*
comment: method to add a comment to a post
commentData: comment data fields to be saved
await commentCache.savePostCommentToCache(): saving a comment to the cache
commentQueue.addCommentJob(): adding the comment to the queue
*/
export class Add {
