...
export class Search {
  /*
  user: this method is used to search for users in the mongoDB
  regex: our search keyword
  users: invokes the userservice method to search for users searchUsers()
  'i': case insensitive operator
  */
