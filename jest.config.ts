...
/*
verbose: reports both failed and successful tests if set to true, else just successful tests
testPathIgnorePatterns: ignore folder
testMatch: this is the dir where our test files will be saved i.e src > test
moduleNameMapper: this allows Jest to see our custom paths
*/
